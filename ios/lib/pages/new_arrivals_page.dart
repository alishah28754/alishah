...
class _NewArrivalGridCard extends StatelessWidget {
              ...
              child: Stack(
                ...
                children: [
                  ...
                  Positioned(
                    bottom: 8,
                    right: 8,
                    child: _NewArrivalProductMenuButton(
...
class _NewArrivalProductMenuButton extends StatelessWidget {
  final VoidCallback onAddToCart;
  final VoidCallback onBuyNow;
  final bool isDark;
  final Color textColor;

  const _NewArrivalProductMenuButton({
    required this.onAddToCart,
    required this.onBuyNow,
    required this.isDark,
    required this.textColor,
